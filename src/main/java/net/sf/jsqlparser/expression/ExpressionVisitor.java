...
public interface ExpressionVisitor {
    ...
    void visit(TrueValue trueValue);

    void visit(FalseValue falseValue);
    ...
    void visit(IsTrueExpression isTrueExpression);

    void visit(IsFalseExpression isFalseExpression);
